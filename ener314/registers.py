...
RF_BITRATE_1200   = 0x682B
RF_BITRATE_2400   = 0x3415
RF_BITRATE_4800   = 0x1A0B
RF_BITRATE_9600   = 0x0D05
RF_BITRATE_19200  = 0x0683
RF_BITRATE_38400  = 0x0341
RF_BITRATE_57600  = 0x022C
RF_BITRATE_76800  = 0x01A1
RF_BITRATE_115200 = 0x0116


RF_FDEV_2000   = 0x0021
RF_FDEV_5000   = 0x0052  # Default
RF_FDEV_7500   = 0x007B
RF_FDEV_10000  = 0x00A4
RF_FDEV_15000  = 0x00F6
RF_FDEV_20000  = 0x0148
RF_FDEV_25000  = 0x019A
RF_FDEV_30000  = 0x01EC
...
# RegIrqFlags2
RF_IRQFLAGS2_FIFOFULL = 0x80            # fifo = 66 bytes
RF_IRQFLAGS2_FIFONOTEMPTY = 0x40        # fifo contains at least one byte
RF_IRQFLAGS2_FIFOLEVEL = 0x20           # bytes in fifo exceep FifoThreshold
RF_IRQFLAGS2_FIFOOVERRUN = 0x10         # fifo > 66 bytes
